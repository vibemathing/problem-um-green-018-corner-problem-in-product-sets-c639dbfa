...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-018-corner-problem-in-product-sets-c639dbfa-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-018"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-018-corner-problem-in-product-sets-c639dbfa-v1",
      "problem_contract_sha256": "06c43f7162e660de671f2c77a062583af4e70de6dc973f92b5b5a442ffcd337f",
      "problem_id": "problem:um-green-018-corner-problem-in-product-sets-c639dbfa",
      "route_id": "route:um-green-018-corner-problem-in-product-sets-c639dbfa-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-018-corner-problem-in-product-sets-c639dbfa-source-fidelity-01",
      "graph_id": "graph:um-green-018-corner-problem-in-product-sets-c639dbfa-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-018-corner-problem-in-product-sets-c639dbfa-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-018-corner-problem-in-product-sets-c639dbfa-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose $G$ is a finite group, and let $A \\subset G \\times G$ be a subset of density $\\alpha$. Are there $\\gg_\\alpha |G|^3$ triples $x, y, g$ such that $(x, y), (gx, y), (x, gy)$ all lie in $A$?"
          },
          "statement_sha256": "6dc4c53e52f04595deea7be6e6dc304307ba087e0f650fa6d77e3ec1464eb613"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-018-corner-problem-in-product-sets-c639dbfa-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-018-corner-problem-in-product-sets-c639dbfa-root",
      "route_id": "route:um-green-018-corner-problem-in-product-sets-c639dbfa-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-018-408c5949566e",
        "url": "https://www.unsolvedmath.com/problems/GREEN-018"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
